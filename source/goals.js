                    ...
                    body: Body({
                        Content: [
                            ...
                            webx.createElement({
                                ...
                                html: [
                                    webx.createElement({
                                        tag: 'video',
                                        attribute: [
                                            { key: 'src', value: './src/assets/blurbg.mp4' },
                                    ...
                                    webx.createElement({
                                        tag: 'div',
                                        attribute: [
                                            { key: 'class', value: 'text-center relative backdrop-blur-2xl z-10 h-screen text-white w-full text-6xl sm:text-[150px] flex items-center justify-center flex-col' }
                                        ],
                                        html: [
                                            h1(`
                                                ☮︎Peace<br>Goals
                                                ...
                                                html: [
                                                    ...
                                                    webx.createElement({
                                                        ...
                                                        html: [
                                                            ...
                                                            a('Learn More', null, '', 'class', 'text-blue-300 hover:text-blue-500 font-thin')
                                                        ]
                                                    })
                                                ]
                                            })
                            ...
                            window.innerWidth > 640 ? webx.createElement({
                                ...
                                html: [
                                    h1('STOP WARS! MAINTAIN ☮︎ PEACE', null, 'class', 'text-[35vw] whitespace-nowrap')
                                ]
                            }) : p(''),
                            webx.createElement({
                                tag: "div",
                                    ...
                                    webx.createElement({
                                        ...
                                        html: [
                                            ...
                                            webx.createElement({
                                                ...
                                                html: [
                                                    h1(`A Calm World`, null, 'class', 'm-16 text-5xl sm:text-[48px]'),
                                                    h1(`Calm world is a better World`, null, 'class', 'm-16 text-2xl sm:text-[28px]')
                                                ]
                                            })
                                        ]
                                    }),
                                    webx.createElement({
                                        ...
                                        html: [
                                            ...
                                            webx.createElement({
                                                ...
                                                html: [
                                                    h1(`Stop wars`, null, 'class', 'text-5xl sm:text-[48px]')
                                                ]
                                            })
                                        ]
                                    }),
                                    webx.createElement({
                                        ...
                                        html: [
                                            ...
                                            webx.createElement({
                                                ...
                                                html: [
                                                    h1(`Inner Peace`, null, 'class', 'text-5xl sm:text-[48px]')
                                                ]
                                            })
                                        ]
                                    })
