                    ...
                    navBar: AppBar({
                        ...
                        Content: [
                            ...
                            webx.createElement({
                                ...
                                html: [
                                    webx.createElement({
                                        tag: 'video',
                                        attribute: [
                                            { key: 'src', value: './src/assets/War.mp4' },
                                            ...
                                            webx.createElement({
                                                ...
                                                html: [
                                                    webx.createElement({
                                                        ...
                                                        html: [
                                                            h1('Stop them they harm peace'),
                                                            h1('Destruction starts with a war'),
                                                            h1('Hence, stop them!')
                                                        ]
                                                    }),
                                                    webx.createElement({
                            ...
                            window.innerWidth > 640 ? webx.createElement({
                                ...
                                html: [
                                    h1('WARS WHICH CAUSE LOSS OF LIVES', null, 'class', 'text-[35vw] whitespace-nowrap')
                                ]
                            }) : p(''),
                            webx.createElement({
                                tag: 'div',
                                ...
                                html: [
                                    webx.createElement({
                                        ...
                                        html: [
                                            ...
                                            webx.createElement({
                                                tag: 'div',
                                                attribute: [
                                                    { key: 'class', value: 'absolute inset-0 flex items-end sm:my-0 mb-4 justify-between text-white z-10 pointer-events-none' }
                                                ],
                                                html: [
                                                    h1(`Hiroshima, Nagasaki`, null, 'class', 'm-16 text-[18px] sm:text-[48px]'),
                                                    h1(`The Nuclear tradegy.`, null, 'class', 'm-16 text-[18px] sm:text-[28px]')
                                                ]
                                            })
                                        ]
                                    }),
                                    webx.createElement({
                                        ...
                                        html: [
                                            webx.createElement({
                                                tag: 'video',
                                                attribute: [
                                                    { key: 'src', value: './src/assets/Ukrane.mp4' },
                                                    { key: 'loop', value: true },
                                                    { key: 'muted', value: true },
                                                    { key: 'class', value: 'object-cover sm:my-0 mb-4 w-full h-full transition duration-300 blur-xl' }
                                                ]
                                            }),
                                            webx.createElement({
                                                tag: 'div',
                                                ...
                                                html: [
                                                    h1(`Ukraine Russia war`, null, 'class', 'text-[18px] sm:text-[48px]')
                                                ]
                                            })
                                        ]
                                    }),
                                    webx.createElement({
                                        tag: 'div',
                                        attribute: [
                                            { key: 'class', value: 'relative rounded-xl sm:my-0 mb-4 overflow-hidden group video-container' }
                                        ], event: 'click',
                                        html: [
                                            webx.createElement({
                                                tag: 'video',
                                                attribute: [
                                                    { key: 'src', value: './src/assets/bench.mp4' },
                                                    { key: 'loop', value: true },
                                                    { key: 'muted', value: true },
                                                    { key: 'class', value: 'object-cover w-full h-full transition duration-300 blur-xl' }
                                                ]
                                            ...
                                            webx.createElement({
                                                ...
                                                html: [
                                                    h1(`Israel & Gaza war`, null, 'class', 'text-[18px] sm:text-[48px]')
                                                ]
                                            })
                                        ]
                                    })
                                ...
                                html: [
                                    webx.createElement({
                                        ...
                                        html: [
                                            ...
                                            RenderElements({
                                                times: Db.PeaceOfMD2.length,
                                                element: function (deltaCounter) {
                                                    return webx.createElement({
                                                        tag: 'span',
                                                        attribute: { key: 'class', value: 'font-extralight animtxt2' },
                                                        html: `${Db.PeaceOfMD2[deltaCounter]} `
                                                    });
                                                }
                                            }),
                                            webx.createElement({
                                                ...
                                                html: [
                                                    webx.createElement({
                                                        ...
                                                        html: [
                                                            h1('More wars = Less humans,'),
                                                            h1('also, wars = More destruction'),
                                                            h1('and less wars more Peace')
                                                        ]
                                                    }),
                                                    webx.createElement({
                                                        tag: 'div',
                                                        ...
                                                        html: [
                                                            h1('The Dooms day clock which tells how near humanity is to self destruction (when clock stricks 12) is telling us that we are close to striking 12 by 89 seconds', null, 'class', 'mb-3'),
                                                            h1('The amount of neuclear weapons has increased exponentially more than the function f(x) = x^2.', null, 'class', 'mb-3'),
                                                            h1('It is our intiative to take care of the world to hence maintain peace', null, 'class', 'mb-3'),
                                                        ]
                                                    })
                                                ]
                                            })
