                    ...
                    body: Body({
                        Content: [
                            ...
                            webx.createElement({
                                ...
                                html: [
                                    webx.createElement({
                                        tag: 'video',
                                        attribute: [
                                            { key: 'src', value: './src/assets/retro.mp4' },
                                            ...
                                            webx.createElement({
                                                ...
                                                html: [
                                                    webx.createElement({
                                                        ...
                                                        html: [
                                                            h1('Sagar Public School,'),
                                                            h1('Saket Nagar'),
                                                            h1('Category Middle School'),
                                                            h1('with +3500 lines code'),
                                                            h1('on this website')
                                                        ]
                                                    }),
                                                    webx.createElement({
                                                        ...
                                                        html: [
                                                            h1('We are the students of grade 8th who worked hard to build this website reaching over +3757 of code if we include webx.js lib code the number reaches to +5850 lines of JS code the students who did this are: ', null, 'class', 'mb-3'),
                                                            h1('Abhijay Singh Meena grade 8th, SPS SN', null, 'class', 'mb-3'),
                                                            h1('Atharv Mishraulia grade 8th SPS SN', null, 'class', 'mb-3'),
                                                        ]
                                                    })
                                                ]
                                            })
                            ...
                            window.innerWidth > 640 ? webx.createElement({
                                ...
                                html: [
                                    h1('DEVELOPERS WHO &lt;C☮︎DE WITH PEACE/&gt;', null, 'class', 'text-[35vw] whitespace-nowrap')
                                ]
                            }) : p(''),
                            webx.createElement({
                                tag: 'div',
